 ...
 */
final class Version20230223033857 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD job_id INT DEFAULT NULL, DROP job');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE personne ADD job VARCHAR(50) DEFAULT NULL, DROP job_id');
    }
}
